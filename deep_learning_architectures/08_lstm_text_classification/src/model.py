...
class LSTMTextClassifier(nn.Module):
    ...
    def forward(self, input_ids: torch.Tensor) -> torch.Tensor:
        ...
        # The LSTM returns recurrent hidden states and a long-term cell state.
        _, (final_hidden, final_cell) = self.lstm(packed)
        del final_cell
        ...
        if self.bidirectional:
            ...
            # The last layer's hidden state summarizes the sequence.
